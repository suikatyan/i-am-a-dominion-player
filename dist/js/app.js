...
(function (CardId) {
    ...
    CardId["Adventurer"] = "Adventurer";
    CardId["Bureaucrat"] = "Bureaucrat";
    CardId["Chancellor"] = "Chancellor";
    CardId["Chapel"] = "Chapel";
    CardId["Feast"] = "Feast";
    CardId["Laboratory"] = "Laboratory";
    CardId["Moneylender"] = "Moneylender";
    CardId["ThroneRoom"] = "ThroneRoom";
    CardId["Festival"] = "Festival";
    CardId["Gardens"] = "Gardens";
    CardId["Library"] = "Library";
    CardId["Spy"] = "Spy";
    CardId["Thief"] = "Thief";
    CardId["Witch"] = "Witch";
    CardId["CouncilRoom"] = "CouncilRoom";
})(CardId || (CardId = {}));
...
(function (CardCategory) {
    ...
    CardCategory["Victory"] = "Victory";
    CardCategory["Action"] = "Action";
    CardCategory["Curse"] = "Curse";
...
Object.defineProperty(exports, "__esModule", { value: true });
const AbstractCard_1 = __webpack_require__(6);
const DI_1 = __webpack_require__(5);
class AbstractActionCard extends AbstractCard_1.default {
    excuteActionEffect() {
...
__decorate([
    DI_1.default.inject()
], AbstractActionCard.prototype, "context", void 0);
__decorate([
    DI_1.default.inject()
], AbstractActionCard.prototype, "notification", void 0);
__decorate([
    DI_1.default.inject()
], AbstractActionCard.prototype, "marketHandler", void 0);
exports.default = AbstractActionCard;
...
Object.defineProperty(exports, "__esModule", { value: true });
const UniqueId_1 = __webpack_require__(68);
class AbstractCard {
    constructor() {
...
const DI_1 = __webpack_require__(5);
const CardFactory_1 = __webpack_require__(10);
const CardSorter_1 = __webpack_require__(86);
class AbstractCardSet {
    ...
    async sort(cards) {
        ...
        for (const [cardId] of cards) {
            builtCards.push(await CardFactory_1.default.build(cardId));
        }
        CardSorter_1.default.sort(builtCards, { isAscending: true, keys: ["cost"] });
...
__decorate([
    DI_1.default.inject()
], AbstractCardSet.prototype, "playerHandler", void 0);
...
var CardSetId;
(function (CardSetId) {
    CardSetId["FirstGame"] = "FirstGame";
    CardSetId["BigMoney"] = "BigMoney";
    CardSetId["Interactoin"] = "Interactoin";
    CardSetId["VillageSquare"] = "VillageSquare";
    CardSetId["SizeDistortion"] = "SizeDistortion";
    CardSetId["Random"] = "Random";
})(CardSetId || (CardSetId = {}));
exports.default = CardSetId;
...
class CardFactory {
    static async build(cardId) {
        try {
            const targetClass = await Promise.resolve().then(function () { return __webpack_require__(67)(`./${cardId}`); });
...
Object.defineProperty(exports, "__esModule", { value: true });
const AbstractActionCard_1 = __webpack_require__(2);
const CardId_1 = __webpack_require__(0);
...
const CellarArea_1 = __webpack_require__(69);
class Cellar extends AbstractActionCard_1.default {
    cardId() {
    ...
    async onExcute() {
        ...
        const area = new CellarArea_1.default(this.context().turn.hand.getCards());
        area.start();
...
Object.defineProperty(exports, "__esModule", { value: true });
const PropertyHandler_1 = __webpack_require__(65);
const AvatarFactory_1 = __webpack_require__(74);
class AbstractPlayer {
    constructor(playerIndex) {
        this.propertyHandler = new PropertyHandler_1.default();
        this._image = AvatarFactory_1.default.build();
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
const AdventurerArea_1 = __webpack_require__(88);
const CardFilter_1 = __webpack_require__(83);
const Sleeper_1 = __webpack_require__(90);
class Adventurer extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Adventurer;
    }
    name() {
        return "冒険者";
    }
    ...
    async onExcute() {
        const cards = [];
        const area = new AdventurerArea_1.default(cards);
        area.start();
        while (true) {
            if (CardFilter_1.CardFilter.filter(cards, { include: [CardFilter_1.FilterKey.Treasure] }).length >= 2) {
                break;
            }
            ...
            await Sleeper_1.default(1000);
        }
        area.end();
        for (const card of cards) {
            if (card.category() === CardCategory_1.default.Treasure) {
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Bureaucrat extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Bureaucrat;
    }
    name() {
        return "役人";
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
class EventAwaiter {
    static async awaiter(parameters) {
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Chancellor extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Chancellor;
    }
    name() {
        return "宰相";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Chapel extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Chapel;
    }
    name() {
        return "礼拝堂";
    }
...
class Copper extends AbstractCard_1.default {
    ...
    cardId() {
        return CardId_1.default.Copper;
    }
    name() {
        return "銅貨";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class CouncilRoom extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.CouncilRoom;
    }
    name() {
        return "議事堂";
    }
...
class Estate extends AbstractCard_1.default {
    ...
    cardId() {
        return CardId_1.default.Estate;
    }
    name() {
        return "屋敷";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Feast extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Feast;
    }
    name() {
        return "祝宴";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Festival extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Festival;
    }
    name() {
        return "祝祭";
    }
...
const CardId_1 = __webpack_require__(0);
const CardCategory_1 = __webpack_require__(1);
class Gardens extends AbstractCard_1.default {
    cardId() {
        return CardId_1.default.Gardens;
    }
    name() {
        return "庭園";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Laboratory extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Laboratory;
    }
    name() {
        return "研究所";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Library extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Library;
    }
    name() {
        return "書庫";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Market extends AbstractActionCard_1.default {
    cardId() {
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Militia extends AbstractActionCard_1.default {
    cardId() {
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
const MineArea1_1 = __webpack_require__(91);
const MineArea2_1 = __webpack_require__(92);
const CardFilter_1 = __webpack_require__(83);
class Mine extends AbstractActionCard_1.default {
    cardId() {
    ...
    async onExcute() {
        ...
        const treasureCardsInHand = CardFilter_1.CardFilter.filter(hand.getCards(), { include: [CardFilter_1.FilterKey.Treasure] });
        const area1 = new MineArea1_1.default(treasureCardsInHand);
        area1.start();
        ...
        const treasureCardsInMarket = CardFilter_1.CardFilter.filter(marketHandler.getMarketCardsWithoutCount(), { include: [CardFilter_1.FilterKey.Treasure], maxCost: selectedCardToTrash.cost() + 3 });
        const treasureAvailableCardsInMarket = treasureCardsInMarket.filter(card => {
            return !marketHandler.isSoldout(card.cardId());
        });
        const area2 = new MineArea2_1.default(treasureAvailableCardsInMarket);
        area2.start();
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Moat extends AbstractActionCard_1.default {
    cardId() {
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Moneylender extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Moneylender;
    }
    name() {
        return "金貸し";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
const RemodelArea1_1 = __webpack_require__(95);
const RemodelArea2_1 = __webpack_require__(96);
const CardFilter_1 = __webpack_require__(83);
class Remodel extends AbstractActionCard_1.default {
    cardId() {
    ...
    async onExcute() {
        ...
        const marketHandler = this.marketHandler();
        const area1 = new RemodelArea1_1.default(hand.getCards());
        area1.start();
        const [selectedCardToTrash] = await area1.play();
        area1.end();
        if (selectedCardToTrash === void 0) {
        ...
        marketHandler.getTrash().push(selectedCardToTrash);
        area1.end();
        const cardsInMarket = CardFilter_1.CardFilter.filter(marketHandler.getMarketCardsWithoutCount(), { maxCost: selectedCardToTrash.cost() + 2 });
        const availableCardsInMarket = cardsInMarket.filter(card => {
            return !marketHandler.isSoldout(card.cardId());
        });
        const area2 = new RemodelArea2_1.default(availableCardsInMarket);
        area2.start();
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Smithy extends AbstractActionCard_1.default {
    cardId() {
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Spy extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Spy;
    }
    name() {
        return "密偵";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Thief extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Thief;
    }
    name() {
        return "泥棒";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class ThroneRoom extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.ThroneRoom;
    }
    name() {
        return "玉座の間";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Village extends AbstractActionCard_1.default {
    cardId() {
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Witch extends AbstractActionCard_1.default {
    cardId() {
        return CardId_1.default.Witch;
    }
    name() {
        return "魔女";
    }
...
const ActionCategory_1 = __webpack_require__(3);
const ActionEffectCollection_1 = __webpack_require__(4);
class Woodcutter extends AbstractActionCard_1.default {
    cardId() {
...
const CardComponent_1 = __webpack_require__(11);
let needView = true;
class Hand {
    constructor() {
        this.cards = [];
...
const CardFactory_1 = __webpack_require__(10);
const CardComponent_1 = __webpack_require__(11);
const CardWithCountComponent_1 = __webpack_require__(77);
class MarketHandler {
    constructor() {
        this.cards = [];
        this.trashCards = [];
...
Object.defineProperty(exports, "__esModule", { value: true });
const AbstractCardSet_1 = __webpack_require__(7);
const CardId_1 = __webpack_require__(0);
const CardSetId_1 = __webpack_require__(9);
class BigMoney extends AbstractCardSet_1.default {
    id() {
        return CardSetId_1.default.BigMoney;
    }
    name() {
        return "ビッグ・マネー";
    }
    async kingdomCards() {
        const cards = await this.sort([
            [CardId_1.default.Adventurer, 10],
            [CardId_1.default.Bureaucrat, 10],
            [CardId_1.default.Chancellor, 10],
            [CardId_1.default.Chapel, 10],
            [CardId_1.default.Feast, 10],
            [CardId_1.default.Laboratory, 10],
            [CardId_1.default.Market, 10],
            [CardId_1.default.Mine, 10],
            [CardId_1.default.Moneylender, 10],
            [CardId_1.default.ThroneRoom, 10],
        ]);
...
class FirstGame extends AbstractCardSet_1.default {
    id() {
        return CardSetId_1.default.FirstGame;
    }
    name() {
        return "最初のゲーム";
    }
...
const CardId_1 = __webpack_require__(0);
const CardSetId_1 = __webpack_require__(9);
class Interaction extends AbstractCardSet_1.default {
    id() {
        return CardSetId_1.default.Interactoin;
    }
    name() {
        return "相互作用";
    }
    async kingdomCards() {
        const cards = await this.sort([
            [CardId_1.default.Bureaucrat, 10],
            [CardId_1.default.Chancellor, 10],
            [CardId_1.default.CouncilRoom, 10],
            [CardId_1.default.Militia, 10],
            [CardId_1.default.Mine, 10],
            [CardId_1.default.Moat, 10],
            [CardId_1.default.Remodel, 10],
...
const CardId_1 = __webpack_require__(0);
const CardSetId_1 = __webpack_require__(9);
const Dice_1 = __webpack_require__(87);
const CardFactory_1 = __webpack_require__(10);
class Random extends AbstractCardSet_1.default {
    id() {
        return CardSetId_1.default.Random;
    }
    name() {
        return "ランダム";
    }
    async kingdomCards() {
        return new Map(await this.sort(await this.selectRandomCards()));
    }
    async selectRandomCards() {
        const cardConfig = [];
        const pickedCardId = [];
        while (cardConfig.length < 10) {
            const cardId = Dice_1.default.selectEnum(CardId_1.default);
...
const CardId_1 = __webpack_require__(0);
const CardSetId_1 = __webpack_require__(9);
class SizeDistortion extends AbstractCardSet_1.default {
    id() {
        return CardSetId_1.default.SizeDistortion;
    }
    name() {
        return "サイズ変形";
    }
    async kingdomCards() {
        const cards = await this.sort([
            ...
            [CardId_1.default.Chapel, 10],
            [CardId_1.default.Feast, 10],
            [CardId_1.default.Gardens, this.playerCount === 2 ? 8 : 12],
            [CardId_1.default.Laboratory, 10],
            [CardId_1.default.Thief, 10],
            [CardId_1.default.Village, 10],
            [CardId_1.default.Witch, 10],
            [CardId_1.default.Woodcutter, 10],
            [CardId_1.default.Workshop, 10],
        ]);
        return new Map(cards);
...
exports.default = SizeDistortion;
...
const CardId_1 = __webpack_require__(0);
const CardSetId_1 = __webpack_require__(9);
class VillageSquare extends AbstractCardSet_1.default {
    id() {
        return CardSetId_1.default.VillageSquare;
    }
    name() {
        return "村の広場";
    }
    async kingdomCards() {
        const cards = await this.sort([
            [CardId_1.default.Bureaucrat, 10],
            [CardId_1.default.Cellar, 10],
            [CardId_1.default.Festival, 10],
            [CardId_1.default.Library, 10],
            [CardId_1.default.Market, 10],
            [CardId_1.default.Remodel, 10],
            [CardId_1.default.Smithy, 10],
            [CardId_1.default.Witch, 10],
...
const Dominion_1 = __webpack_require__(78);
(async () => {
...
const PlayerHandler_1 = __webpack_require__(63);
const NotificationHandler_1 = __webpack_require__(76);
const MarketHandler_1 = __webpack_require__(48);
...
DI_1.default.subscribe("marketHandler", new MarketHandler_1.default());
...
Object.defineProperty(exports, "__esModule", { value: true });
const TurnContext_1 = __webpack_require__(58);
const GameContext_1 = __webpack_require__(62);
class Context {
    constructor() {
        this.game = new GameContext_1.default();
        this.turn = new TurnContext_1.default();
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const DI_1 = __webpack_require__(5);
const TurnPointHandler_1 = __webpack_require__(59);
class TurnContext {
    initialize() {
...
__decorate([
    DI_1.default.inject()
], TurnContext.prototype, "playerHandler", void 0);
exports.default = TurnContext;
...
Object.defineProperty(exports, "__esModule", { value: true });
const Lord_1 = __webpack_require__(64);
const Robot_1 = __webpack_require__(75);
const vue_1 = __webpack_require__(8);
class PlayerHandler {
    constructor() {
        this.players = [];
...
Object.defineProperty(exports, "__esModule", { value: true });
const AbstractPlayer_1 = __webpack_require__(14);
...
Object.defineProperty(exports, "__esModule", { value: true });
const Deck_1 = __webpack_require__(66);
const Hand_1 = __webpack_require__(47);
const Field_1 = __webpack_require__(72);
const Discarded_1 = __webpack_require__(73);
...
var map = {
	...
	"./Curse": 22,
	"./Curse.ts": 22,
	"./DefaultAreaComponent": 94,
	"./DefaultAreaComponent.ts": 94,
	"./Duchy": 23,
	"./Duchy.ts": 23,
	"./Estate": 24,
	"./Estate.ts": 24,
...
const DefaultAreaComponent_1 = __webpack_require__(71);
class CellarArea extends AbstractActionArea_1.default {
    constructor(cards) {
        super();
        this.cards = [];
        this.selectedCards = [];
    ...
    start() {
        ...
        this.view = new vue_1.default({
            ...
            components: {
                "area-component": DefaultAreaComponent_1.default,
            },
        });
    }
    async play() {
...
AbstractActionArea.AREA_ID = "action-area";
AbstractActionArea.DONE_BUTTON_ID = "action-area-done-button";
__decorate([
    DI_1.default.inject()
], AbstractActionArea.prototype, "context", void 0);
exports.default = AbstractActionArea;
...
exports.default = {
    ...
    methods: {
        toggleSelect: function (event) {
            ...
            const cards = this.parameters.cards;
            const selectedCards = this.parameters.selectedCards;
            const { max } = this.parameters.count;
            const index = selectedCards.findIndex(card => itemId === card.itemId());
            if (index === -1) {
                if (selectedCards.length >= max) {
                    return;
                }
                selectedCards.push(cards.find(card => itemId === card.itemId()));
            }
            else {
                selectedCards.splice(index, 1);
            }
        },
        isSelected: function (targetCard) {
            const selectedCards = this.parameters.selectedCards;
    ...
    computed: {
        isDisabled: function () {
            const selectedCards = this.parameters.selectedCards;
            const { min } = this.parameters.count;
...
Object.defineProperty(exports, "__esModule", { value: true });
const AbstractApplication_1 = __webpack_require__(79);
const SessionHandler_1 = __webpack_require__(80);
const DI_1 = __webpack_require__(5);
const CardSetFactory_1 = __webpack_require__(84);
const Util_1 = __webpack_require__(13);
class Dominion extends AbstractApplication_1.default {
    ...
    async buildCardSet() {
        const cardSetName = Util_1.default.getUrlParameters("cardset");
        if (typeof cardSetName === "string") {
            return await CardSetFactory_1.default.build(cardSetName);
        }
        else {
    ...
    async startSession() {
        this.sessionHandler = new SessionHandler_1.default();
...
__decorate([
    DI_1.default.inject()
], Dominion.prototype, "context", void 0);
exports.default = Dominion;
...
Object.defineProperty(exports, "__esModule", { value: true });
const TurnHandler_1 = __webpack_require__(81);
const DI_1 = __webpack_require__(5);
const CardId_1 = __webpack_require__(0);
class Session {
    ...
    async start() {
        while (this.canContinue()) {
            ...
            const turn = new TurnHandler_1.default();
            await turn.start();
        }
        alert("ゲーム終了！");
    }
    canContinue() {
        ...
        const condition1 = SoldOutCardIds.some((cardId) => {
            switch (cardId) {
                case CardId_1.default.Province:
                    return true;
            }
            return false;
        });
...
__decorate([
    DI_1.default.inject()
], Session.prototype, "playerHandler", void 0);
__decorate([
    DI_1.default.inject()
], Session.prototype, "marketHandler", void 0);
...
const CardCategory_1 = __webpack_require__(1);
const DI_1 = __webpack_require__(5);
const CardPicker_1 = __webpack_require__(82);
const Hand_1 = __webpack_require__(47);
const MarketHandler_1 = __webpack_require__(48);
const CardFilter_1 = __webpack_require__(83);
class TurnHandler {
    constructor() {
        this.isSkipableForCoinPick = false;
    }
    async start() {
        this.onStartTurn();
    ...
    async onStartActionPhase() {
        if (CardFilter_1.CardFilter.filter(this.context().turn.hand.getCards(), { include: [CardFilter_1.FilterKey.Treasure, CardFilter_1.FilterKey.Action] }).length === 0) {
            return true;
        }
        while (true) {
            ...
            this.onStartActionEach(selectedCard);
            await this.onExcuteAction(selectedCard);
            this.onEndActionEach();
        }
    }
    async getActionSelectedCard() {
        if (this.context().turn.currentPlayer.isRobot()) {
            return;
        }
        const result = await CardPicker_1.default.cardAndButton(this.context().turn.hand.getCards(), Hand_1.default.querySelectorAll());
        if (result === null) {
            throw new Error();
        }
        if (!result) {
    ...
    async onStartBuyPhase() {
        while (!this.isSkipableForCoinPick) {
            ...
            if (CardFilter_1.CardFilter.filter(this.context().turn.hand.getCards(), { include: [CardFilter_1.FilterKey.Treasure] }).length === 0) {
                break;
            }
            const selectedCard = await this.getActionSelectedCard();
            if (!selectedCard) {
            ...
            if (selectedCard.category() === CardCategory_1.default.Treasure) {
                this.isSkipableForCoinPick = true;
            }
        }
        this.notification().say("購入するカードを選んでください。\nまたは、ターンを終了してください。");
        const treasureCards = CardFilter_1.CardFilter.filter(this.context().turn.hand.getCards(), { include: [CardFilter_1.FilterKey.Treasure] });
        this.context().turn.turnPointHandler.coin.increase(treasureCards.reduce((previous, current) => {
            return current.category() === CardCategory_1.default.Treasure ? current.value() + previous : previous;
        }, 0));
    ...
    async getSelectedBuyCard() {
        ...
        const result = await CardPicker_1.default.cardAndButton(this.marketHandler().getMarketCards().map((item) => item.card), MarketHandler_1.default.querySelectorAll());
        if (result === null) {
            throw new Error();
        }
        if (!result) {
...
__decorate([
    DI_1.default.inject()
], TurnHandler.prototype, "context", void 0);
__decorate([
    DI_1.default.inject()
...
class CardPicker {
    ...
    static async card(cards, targets) {
    ...
    static async cardAndButton(cards, targets) {
...
class CardFilter {
    ...
    static hasCategory(card, categoryKeys) {
        for (const key of categoryKeys) {
            if (card.category() === CardCategory_1.default[key]) {
                return true;
            }
        }
        return false;
...
class CardSetFactory {
    static async build(cardSetName) {
        try {
            const targetClass = await Promise.resolve().then(function () { return __webpack_require__(85)(`./${CardSetFactory.getCardSetName(cardSetName)}`); });
            return new targetClass.default;
        }
        catch (e) {
...
Object.defineProperty(exports, "__esModule", { value: true });
class CardSorter {
    static sort(cards, way) {
        return cards.sort((cardA, cardB) => {
            return this.prepare(cardA, cardB, way);
        });
    }
    static prepare(cardA, cardB, { isAscending, keys }) {
        let result = 0;
        for (const key of keys) {
            switch (key) {
                case "cost":
                    ...
                    break;
                case "value":
                    const treasureCardA = cardA;
                    const treasureCardB = cardA;
                    result = this.compare(treasureCardA.value(), treasureCardB.value(), isAscending);
                    break;
                case "victoryPoint":
                    const victoryCardA = cardA;
                    const victoryCardB = cardA;
    ...
    static compare(valueA, valueB, isAscending) {
        if (valueA === valueB) {
            return 0;
        }
        if (valueA > valueB) {
...
const vue_1 = __webpack_require__(8);
const AbstractActionArea_1 = __webpack_require__(70);
const CardsAreaComponent_1 = __webpack_require__(89);
const Adventurer_1 = __webpack_require__(15);
class AdventurerArea extends AbstractActionArea_1.default {
    constructor(cards) {
        super();
        this.cards = [];
        this.cards = cards;
    ...
    start() {
        ...
        this.view = new vue_1.default({
            ...
            data: {
                parameters: {
                    cards: this.cards,
                    source: new Adventurer_1.default(),
                    description: "財宝カードが2枚出るまで山札から公開します。その財宝カードは手札に加え、他のカードは捨て札にします。",
                },
            },
            components: {
                "area-component": CardsAreaComponent_1.default,
            },
        });
    }
}
exports.default = AdventurerArea;
...
const EventAwaiter_1 = __webpack_require__(17);
const DefaultAreaComponent_1 = __webpack_require__(71);
class MineArea1 extends AbstractActionArea_1.default {
    constructor(cards) {
        super();
        this.cards = [];
        this.selectedCards = [];
...
const EventAwaiter_1 = __webpack_require__(17);
const DefaultAreaComponent_1 = __webpack_require__(71);
class MineArea2 extends AbstractActionArea_1.default {
    constructor(cards) {
        super();
        this.cards = [];
        this.selectedCards = [];
...
const EventAwaiter_1 = __webpack_require__(17);
const DefaultAreaComponent_1 = __webpack_require__(71);
const Remodel_1 = __webpack_require__(37);
class RemodelArea1 extends AbstractActionArea_1.default {
    constructor(cards) {
        super();
        this.cards = [];
        this.selectedCards = [];
