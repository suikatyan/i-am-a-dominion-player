...
class Estate extends __WEBPACK_IMPORTED_MODULE_0_card_AbstractCard__["a" /* default */] {
    value() {
        return 1;
    }
    cardId() {
        return __WEBPACK_IMPORTED_MODULE_1_list_CardId__["a" /* default */].Estate;
    }
    name() {
        return "屋敷";
    }
    category() {
        return __WEBPACK_IMPORTED_MODULE_2_list_CardCategory__["a" /* default */].Victory;
    }
    cost() {
        return 2;
    }
...
/* harmony export (immutable) */ __webpack_exports__["default"] = Estate;
